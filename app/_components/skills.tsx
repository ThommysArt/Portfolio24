    ...
    return (
        <section className="container py-8 md:py-24 p-4">
            ...
            <div className="row-span-7 lg:col-span-6 grid grid-flow-rows grid-rows-7 gap-4 p-4">
                ...
                <div className="flex flex-row justify-center"><a href="/resume.pdf" className="flex flex-row gap-2 px-4 py-2 rounded-lg items-center bg-blue-600 hover:bg-blue-800">Download CV <DownloadIcon/></a></div>
            </div>
