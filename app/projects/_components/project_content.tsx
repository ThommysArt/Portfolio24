    ...
    return (
        <Card>
            <CardHeader className="flex flex-row gap-4 justify-center align-center items-center">
                <CardTitle className="relative z-10 text-xl md:text-3xl bg-clip-text text-transparent bg-gradient-to-b from-slate-200 to-slate-600 uppercase text-center font-bold">
                    {project.title}
                </CardTitle>
            ...
            <CardContent>
                <div className="flex flex-col">
                    <h6 className="relative z-10 text-lg md:text-xl bg-clip-text text-transparent bg-gradient-to-b from-slate-200 to-slate-600 font-bold mt-5 md:mt-10">
                        Role
                    </h6>
